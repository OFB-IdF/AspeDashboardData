...
if(getRversion() >= "2.15.1")  utils::globalVariables(c(
  ...
  "operations", "stations", "observations", "indicateurs", "pop", "sh_geo", "dh_geo", "date_export",
  "pop_geo", "classe_ipr", "CouleursIpr",
  # Variables dplyr
  ...
  "altitude", "sup_500m", "ipr", "cli_libelle", "ipr_nte", "ipr_ner",
